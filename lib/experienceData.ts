...
export const experience: Company[] = [
  {
    ...
    roles: [
      ...
      },
      {
        ...
        results: {
          heading: 'Results in Last 12 Months',
          items: [
          ...
          closingNote: '5 consecutive quarters of growth - scaling from 1 AE to a 4-person team while improving attainment from 60% to 150%.',
        },
      },
    ],
  },
